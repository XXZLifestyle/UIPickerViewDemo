...
#define XXZLog( s, ... ) NSLog( @"[%@ : (%d)] => %@", [[NSString stringWithUTF8String:__FILE__] lastPathComponent], __LINE__, [NSString stringWithFormat:(s), ##__VA_ARGS__] )
...
// 系统控件默认高度
#define XXZStatusBarHeight      (20.f)
#define XXZTopBarHeight         (44.f)
#define XXZTabBarHeight         (49.f)
#define XXZStatusAndNavHeight (XXZStatusBarHeight+XXZTopBarHeight)

//cell默认高度
#define XXZCellDefaultHeight   (44.f)
